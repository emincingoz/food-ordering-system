package com.emin.cingoz.order.service.domain.mapper;
...
import com.emin.cingoz.order.service.domain.valueobject.StreetAddress;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemToOrderItemEntities(
            List<com.emin.cingoz.order.service.domain.dto.create.OrderItem> orderItems) {
